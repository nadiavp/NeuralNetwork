...
def pickle_wsu():
    ...
    avista_125 = setup_elec_utility()
    avista_122 = setup_elec_utility()
    avista_124 = setup_elec_utility()
    avista_111 = setup_elec_utility()
    avista_131 = setup_elec_utility()
    avista_117 = setup_elec_utility()
...
def load_network(gens):
    ...
    equipment = [[gens[0], gens[17], gens[21], gens[22]],\
         [gens[6], gens[7], gens[3], gens[-6]],\
         [gens[5], gens[2], gens[-5]],\
         [gens[12], gens[13], gens[14], gens[15], gens[16], gens[8], gens[9], gens[-4]],\
         [gens[-3]],\
         [gens[10],gens[11], gens[4], gens[18], gens[-2]],\
         [gens[19], gens[20], gens[-1]]]
    e_connections = [['SPU125'], ['TUR115', 'SPU122'],['SPU125', 'SPU124'], ['SPU122'], [],[],[]]
    h_connections = [['TUR117', 'SPU125'],['TUR115', 'SPU122'],['SPU125', 'SPU124'], ['SPU122', 'TUR111'],['SPU124', 'TUR131'],['TUR111', 'TUR117'], ['TUR131', 'TUR115']]
    c_connections = [['TUR117', 'SPU125'],['TUR115', 'SPU122'],['SPU125', 'SPU124'], ['SPU122', 'TUR111'],['SPU124', 'TUR131'],['TUR111', 'TUR117'],['TUR131', 'TUR115']]
