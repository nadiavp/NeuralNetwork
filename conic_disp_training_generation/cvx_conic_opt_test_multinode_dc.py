...
def sort_solution(prob, var_name_list, T, forecast):
    ...
    for t in range(T):
        ...
        sheet1.write(t+1, n_col+3, forecast.demand.eq[0,t])
        sheet1.write(t+1, n_col+4, forecast.demand.h[0,t])
        sheet1.write(t+1, n_col+5, forecast.demand.c[0,t])
...
T = 24
allow_dumping=True
allow_thermal_slack = True #False
