...
def pickle_wsu():
    ...
    components = [elec_utility, gas_utility, gt1, carrier_chiller1, cold_water_tank, 
        boiler1, york_chiller1, york_chiller3, carrier_chiller7, carrier_chiller8, carrier_chiller2,
        carrier_chiller3, carrier_chiller4, trane_chiller, gt2, gen_3, boiler2, boiler3, boiler4,
        boiler5, rooftop_pv, ground_pv, diesel_utility]
...
#establish utilities
def setup_elec_utility():
    rt_summer = np.ones((7,24))
    rt_summer[1:6,8:20] = 3*np.ones((5,12))
    r_summer = np.array([
        [0.0551, 0],
        [0.0551, 0],
        [0.0551, 0]
...
def load_network(gens):
    names = ['TUR115', 'SPU125', 'SPU122', 'SPU124', 'TUR111', 'TUR131', 'TUR117', 'Avista']#, 'cold_water_loop', 'steam_loop']
    equipment = [[gens[18], gens[19], gens[17]],\
         [gens[6], gens[7], gens[3]],\
         [gens[5], gens[2]],\
         [gens[14], gens[12], gens[13], gens[8], gens[9], gens[16], gens[17]],\
         [],\
         [gens[10],gens[11], gens[4]],\
         [gens[20], gens[21]], [gens[0], gens[1], gens[22]]]#, [], []] #avista: utilities
    e_connections = [['Avista'], ['Avista'],['Avista'],\
        ['Avista'], ['Avista'],['Avista'],['Avista'],\
        ['TUR115', 'SPU125', 'SPU122', 'SPU124', 'TUR111', 'TUR131', 'TUR117']]#, [], []]
    h_connections = [['TUR117', 'SPU125'],['TUR115', 'SPU122'],['SPU125', 'SPU124'], ['SPU122', 'TUR111'],['SPU124', 'TUR131'],['TUR111', 'TUR117'], ['TUR131', 'TUR115'],[]]
    c_connections = [['TUR117', 'SPU125'],['TUR115', 'SPU122'],['SPU125', 'SPU124'], ['SPU122', 'TUR111'],['SPU124', 'TUR131'],['TUR111', 'TUR117'],['TUR131', 'TUR115'],[]]#[['cold_water_loop'], [], ['cold_water_loop'], ['cold_water_loop'], ['cold_water_loop'], ['cold_water_loop'], [], [],\
         #['TUR115', 'SPU122', 'SPU124', 'TUR111', 'TUR131'], []]
    # h_connections = [['SPU125', 'SPU122', 'SPU124', 'TUR111', 'TUR131'], ['TUR115', 'SPU122', 'SPU124', 'TUR111', 'TUR131'], ['TUR115','SPU125', 'SPU124', 'TUR111', 'TUR131'],\
    #     ['TUR115','SPU125', 'SPU122', 'TUR111', 'TUR131'], ['TUR115','SPU125', 'SPU122', 'SPU124', 'TUR131'], ['TUR115','SPU125', 'SPU122', 'SPU124', 'TUR111'], [], []]
    # c_connections = [['SPU125','SPU124','TUR111','TUR131'],[], ['TUR115','SPU124','TUR111','TUR131'], ['TUR115','SPU125','TUR111','TUR131'], ['TUR115','SPU125','SPU124','TUR131'], \
    #     ['TUR115','SPU125','SPU124','TUR111'], [], []]
